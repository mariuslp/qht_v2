	...
	\begin{filecontents*}[overwrite]{graphs/100.dat}
...
\end{filecontents*}
	\begin{filecontents*}[overwrite]{graphs/500.dat}
L	 FPR 	 FNR 	 Error 	 1-E 	 Phi 	 percentDup
...
\end{filecontents*}
	...
	\begin{filecontents*}[overwrite]{graphs/1000.dat}
		L	 FPR 	 FNR 	 Error 	 1-E 	 Phi 	 percentDup
...
\end{filecontents*}
	...
	\begin{filecontents*}[overwrite]{graphs/5000.dat}
L	 FPR 	 FNR 	 Error 	 1-E 	 Phi 	 percentDup
...
\end{filecontents*}
	\begin{filecontents*}[overwrite]{graphs/10000.dat}
		L	 FPR 	 FNR 	 Error 	 1-E 	 Phi 	 percentDup
...
\begin{filecontents*}[overwrite]{graphs/30000.dat}
L	 FPR 	 FNR 	 Error 	 1-E 	 Phi 	 percentDup
...
\end{filecontents*}
	...
	\begin{filecontents*}[overwrite]{graphs/50000.dat}
L	 FPR 	 FNR 	 Error 	 1-E 	 Phi 	 percentDup
...
\end{filecontents*}
	...
	\begin{filecontents*}[overwrite]{graphs/100000.dat}
		L	 FPR 	 FNR 	 Error 	 1-E 	 Phi 	 percentDup
...
\end{filecontents*}
	...
	\begin{tikzpicture}
	\begin{semilogxaxis}[legend cell align = right, width=0.65\textwidth, legend pos = outer north east, ylabel= $\FPR^w + \FNR^w (\times 100)$, xlabel = L, nodes={scale=0.85, transform shape}]
