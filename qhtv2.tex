...
\begin{theorem}
	...
	$\FN_{\mathcal F,m}$ is the probability of false negative of any subfilter $\mathcal F$ after $m$ insertions, and
	\begin{equation*}
		p_m = \frac{1-\left(1-\frac 1{|\Gamma|}\right)^m}{1-\left(1-\frac 1{|\Gamma|}\right)^w} \approx \frac{m}{w}.
	\end{equation*}
\end{theorem}
