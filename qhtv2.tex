...
\begin{figure}[!ht]
	...
	\caption{Error rate (times 100) of various queuing filters on various sliding window sizes, $M=100000$, $L=10$, $|\Gamma| = 2^{18}$, on a stream of size $10^7$.}\label{tab:comparing_queuing}
\end{figure}
%\begin{table}[]
...
\begin{figure}
	...
	\caption{Evolution of the error rate of a queueing QHT depending on the $L$ value, for various sliding window sizes, with $M=100000$, $|\Gamma| = 2^{18}$, on a stream of size $10^6$.}\label{fig:bench_l}
\end{figure}
