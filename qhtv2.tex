...
\begin{theorem}
	\label{thm:queue-pfp}
	 Let $\FP_{\mathcal Q, m}^w$ be the probability of false positive (def. \ref{def:pfp-pfn}) of $\mathcal Q$ after $m$ insertions, over a sliding window of size $w = cL$, we have:
	\begin{equation}
		\label{eq:queue-pfp}
