...
\subsection{How many subfilters?}
The parameter $L$ determines how many subfilters appear in the queueing construction. Summing up the false positive and false negative rates, we have a total error rate 
\begin{equation}
