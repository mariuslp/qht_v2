...
A quick description of the Compact Short Hash Filter (CSHF) is given in Algorithm~\ref{alg:CSHF}.

\begin{algorithm}[]
	\caption{CSHF, Lookup and Insert}\label{alg:CSHF}
...
\begin{figure}
	...
	\caption{Value $w_{max}$ for which SHF and CSHF reach an error of 50\% ($\pm 0.001$), for various values of $M$.}\label{fig:w_opt}
\end{figure}
