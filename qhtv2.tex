...
Therefore, in the steady-state regime, the queuing filter holds information about at least $c(L-1)$  elements(immediatey after deleting the last subfilter) and at most $cL$ elements (immediately before this deletion). 
