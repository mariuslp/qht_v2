...
In this section, we briefly give the expression of these values. For the sake of simplicity, we only give the FPR and FNR of a queueing filter $\mathcal Q$ after $m = cn$ insertions, where $n$ is a positive integer.
\begin{theorem}
