...
From the above expressions we can derive relatively compact explicit formulas for the queuing filter's FPR and FNR:
\begin{align*}
	\FPR_{\mathcal Q, cn}^w
...
\end{align*}
In particular, these quantities do not depend on $n$. A corollary is that the queuing filter does not exhibit saturation.
