...
indicate an approximately linear relationship between $M$ and $w_\text{max}$ for large values of $M$: $w_\text{max}^\text{CSHF} = 0.0627 M + 443$ ($r^2 = 0.9981$) and $w_\text{max}^\text{SHF} = 0.0233 M + 186$ ($r^2 = 0.9977$).
