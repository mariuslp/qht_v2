...
\begin{theorem}
	For $M \geq w (\log_2(w) + 2\log_2(|\Gamma|))$, the sliding window DDP can be solved exactly (with no errors) in constant time.
\end{theorem}
...
\end{proof}
The dependence on $\log_2 |\Gamma|$ can be dropped, at the cost of allowing 
errors:
\begin{theorem}
...
If solving the equation for individual cases is 
%\end{equation*}
