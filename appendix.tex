\section{SHF and queueing filter algorithms}\label{app:algo}
In this appendix, we give the pseudocode of our two structures, which we removed from the main part of the paper for page limit reasons.
\begin{algorithm}
	...
	\begin{algorithmic}[1]
		...
		\State $h \gets$ hash function of codomain size $\lfloor \frac M{2w} - \frac 12 \log_2 w \rfloor$ bits
